...
export default function DocumentsView({ project, notify }: { project: Project; notify: (message: string) => void }) {
  ...
  const chooseDocument = (id: string) => {
    setDocumentId(id); setPage(1); setRangeValue('1'); setPageMap([]); setBatchResults([])
